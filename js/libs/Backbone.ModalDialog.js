    ...
    Backbone.View.extend(
    {
        ...
        hideModal:
            function()
            {
                ...
                if (this.options.preventClose)      // rob
                    return;
                        ...
                        $("<a href='#' id='modalCloseButton'>&#160;</a>")
                            ...
                            .hover(
                                function()
                                {
                                    ...
                                    $(this).css("background", "transparent url(" + view.options.closeImageHoverUrl + ") top left no-repeat");   // rob
                                },
                                function()
                                {
                                    //$(this).css("background-image", "url(" + view.options.closeImageUrl + ") !important");
                                    $(this).css("background", "transparent url(" + view.options.closeImageUrl + ") top left no-repeat");        // rob
                                })
                            .click(
                                function( event)
                                {
